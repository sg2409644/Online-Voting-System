...
<section>
    ...
    <center><img src="login-pic.svg"></center><br>
            ...
            <input type="text" placeholder="Voter ID" name="vid" required><br><br>
                <i class="fa fa-unlock-alt" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;<input type="password" placeholder="password" name="pass"><br><br><br>
                
                <input type="submit" class="btn btn-outline-secondary" value="Log In" name="login" required></form><br><br>
                </center></div>
    ...
    <?php
        if(isset($_POST['login'])){
            ...
            $vid=$_POST['vid'];
            $password=$_POST['pass'];
            $sql="SELECT * FROM candidate WHERE vid='{$vid}' AND password='{$password}'";
            ...
            if(mysqli_num_rows($result)>0){
                while($row= mysqli_fetch_assoc($result)){
                    ...
                    header("Location: {$hostname}/candidate/dashboard.php");
                }
            }else{
